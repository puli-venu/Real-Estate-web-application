    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit}
        ...
        <p className='text-sm self-center'>
          {fileUploadError?
          (<span className='text-red-700'>Error Image uploadImage must be less than 2mb</span>)  :
        ...
        <input type="text" placeholder='email' defaultValue={currentUser.email}  onChange={handleChange}
        ...
        <Link className="bg-green-700 text-white p-3 uppercase rounded-lg text-center hover:opacity-95 hover:cursor-pointer" 
          to={"/create-listing"}>
            Create Listing
        </Link>
      ...
      </p>
      {
        ...
        userListings.map((listing)=>(
          <div key={listing._id} className='border rounded-lg p-3 flex justify-between items-center gap-4'>
            ...
            <img src={listing.imageUrls[0]} alt="listing" className='h-20 w-20 object-contain' />
            </Link>
